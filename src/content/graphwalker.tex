%----------------------------------------------------------------------------
\chapter{Testing testing tools}\label{sect:GraphWalker implementation of Garage Gate model}
...
%TODO implement SpecExplorer stuff
\section{SpecExplorer implementation}